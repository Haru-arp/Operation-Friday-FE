                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input id="item" type="text" placeholder="아이템을 입력하세요" value={formData.item} onChange={(e) => setFormData({ ...formData, item: e.target.value })} />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input id="leftAccount" value={formData.leftAccountName} onChange={(e) => setFormData({ ...formData, leftAccountName: e.target.value })} />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="rightAccount">대상 계정</Label>
                            <Input id="rightAccount" value={formData.rightAccountName} onChange={(e) => setFormData({ ...formData, rightAccountName: e.target.value })} />
                        </div>
                    </div>
